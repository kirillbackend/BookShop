...
namespace BookLinks.Repositories.Migrations
{
    ...
    [Migration("20231114091705_updateTableKey")]
    partial class updateTableKey
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookOrder", b =>
                {
                    b.HasOne("BookLinks.Repositories.Models.Book", null)
                        .WithMany()
                        .HasForeignKey("BooksId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BookLinks.Repositories.Models.Order", null)
                        .WithMany()
